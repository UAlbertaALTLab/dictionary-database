 ...
 * @return {Object}      An Object containing information parsed from the entry, containing the following fields: `head`, `POS`, `definitions`, `sources`. The `sources` property is always an Array, but sometimes zero length.
 */
