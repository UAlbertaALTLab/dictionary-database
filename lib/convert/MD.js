...
/**
 * Create a key from an MD entry.
 * @param  {Object} entry The MD entry to create a key from.
 * @return {String}
 */
function createMDKey({ lemma, definition }) {
...
export default async function convertCW(inputPath, outputPath, mappingsPath) {
  ...
  if (mappingsPath) {
    ...
    for (const entry of entries) {
      ...
      entry.lemma.sro = mapping?.lemma_CW;
    }
